...
class MainMenuOption extends Option
{
	...
	{
		FlxG.save.data.lol = !FlxG.save.data.lol;
		trace('main menu mode : ' + FlxG.save.data.lol);
		display = updateDisplay();
		return true;
	}
	
	private override function updateDisplay():String
		return "main menu mode " + (FlxG.save.data.lol ? "current" : "fnf");
}
